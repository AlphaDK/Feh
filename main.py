...
async def on_message(message):
    ...
    if message.content.lower().startswith("!draug") or message.content.lower().startswith("!knowyourdraug"): #Source: reddit, it's important to be familiar with Draug and his variants
        ...
        await client.change_presence(game=discord.Game(name=gaem, url="http://twitch.tv/GoGoMic", type=int(playtype)))
        ...
        await client.change_nickname(client.get_server(message.content[6:24]).get_member(user_id="366885945846267906"), message.content[25:])
